                        ...
                        <tr>
                            ...
                            <td>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#df6')]/text()">
                                    <span class="df6"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#df6')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#poems1')]/text()">
                                    <span class="poems1"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#poems1')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#poems2')]/text()">
                                    <span class="poems2"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#poems2')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#poems3')]/text()">
                                    <span class="poems3"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#poems3')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#ce')]/text()">
                                    <span class="ce"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#ce')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#fh')]/text()">
                                    <span class="fh"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#fh')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#bm')]/text()">
                                    <span class="bm"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#bm')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#lSD')]/text()">
                                    <span class="lsd"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#lSD')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#LETTER')]/text()">
                                    <span class="LETTER"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#LETTER')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#D')]/text()">
                                    <span class="D"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#D')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[1]/rdg[@wit/contains(., '#CP')]/text()">
                                    <span class="CP"><xsl:apply-templates select="app[1]/rdg[@wit/contains(., '#CP')]"/></span><br/>
                                </xsl:if>
                            </td>
                            <td>
                                <xsl:if test="text()[2]">
                            ...
                            <td>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#df6')]/text()">
                                    <span class="df6"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#df6')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#poems1')]/text()">
                                    <span class="poems1"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#poems1')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#poems2')]/text()">
                                    <span class="poems2"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#poems2')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#poems3')]/text()">
                                    <span class="poems3"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#poems3')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#ce')]/text()">
                                    <span class="ce"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#ce')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#fh')]/text()">
                                    <span class="fh"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#fh')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#bm')]/text()">
                                    <span class="bm"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#bm')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#lSD')]/text()">
                                    <span class="lsd"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#lSD')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#LETTER')]/text()">
                                    <span class="LETTER"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#LETTER')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#D')]/text()">
                                    <span class="D"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#D')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[2]/rdg[@wit/contains(., '#CP')]/text()">
                                    <span class="CP"><xsl:apply-templates select="app[2]/rdg[@wit/contains(., '#CP')]"/></span><br/>
                                </xsl:if>
                            </td>
                            <td>
                                <xsl:if test="text()[3]">
                            ...
                            <td>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#df6')]/text()">
                                    <span class="df6"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#df6')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#poems1')]/text()">
                                    <span class="poems1"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#poems1')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#poems2')]/text()">
                                    <span class="poems2"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#poems2')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#poems3')]/text()">
                                    <span class="poems3"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#poems3')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#ce')]/text()">
                                    <span class="ce"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#ce')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#fh')]/text()">
                                    <span class="fh"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#fh')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#bm')]/text()">
                                    <span class="bm"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#bm')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#lSD')]/text()">
                                    <span class="lsd"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#lSD')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#LETTER')]/text()">
                                    <span class="LETTER"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#LETTER')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#D')]/text()">
                                    <span class="D"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#D')]"/></span><br/>
                                </xsl:if>
                                <xsl:if test="app[3]/rdg[@wit/contains(., '#CP')]/text()">
                                    <span class="CP"><xsl:apply-templates select="app[3]/rdg[@wit/contains(., '#CP')]"/></span><br/>
                                </xsl:if>
                            </td>
                            <td>
                                <xsl:if test="text()[4]">
